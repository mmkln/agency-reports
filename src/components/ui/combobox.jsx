...
function ComboboxList({
  ...
  return (
    <ComboboxPrimitive.List
      ...
      className={cn(
        "no-scrollbar max-h-72 scroll-py-item overflow-y-auto overscroll-contain p-item data-empty:p-0",
        className
      )}
      {...props} />
  );
...
function ComboboxItem({
  ...
  return (
    <ComboboxPrimitive.Item
      ...
      className={cn(
        "relative flex min-h-control-small w-full cursor-default items-center gap-item rounded-item py-tag pr-panel pl-control text-ui text-text-primary outline-hidden transition-colors duration-motion-fast ease-motion-standard select-none data-highlighted:bg-control-hover data-highlighted:text-text-primary data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}>
      {children}
...
function ComboboxEmpty({
  ...
  return (
    <ComboboxPrimitive.Empty
      ...
      className={cn(
        "hidden w-full justify-center py-card text-center text-ui text-text-muted group-data-empty/combobox-content:flex",
        className
      )}
      {...props} />
  );
