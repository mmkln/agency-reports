export const PORTAL_REPOSITORY_COLLECTIONS = Object.freeze([
  ...
  { key: 'growthReviewSnapshots', tableName: 'growth_review_snapshots' },
  { key: 'normalizedBookings', tableName: 'normalized_bookings' },
  { key: 'normalizedContactEvents', tableName: 'normalized_contact_events' },
  { key: 'normalizedLeads', tableName: 'normalized_leads' },
  { key: 'rawGhlEvents', tableName: 'raw_ghl_events' },
