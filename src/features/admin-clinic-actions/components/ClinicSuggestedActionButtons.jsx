...
function getSuggestionLabel(suggestion) {
  return suggestion.actionLabel ?? suggestion.label
}

export function ClinicSuggestedActionButtons({
  createdActionKeys,
  createPayload,
  creatingActionKey,
  isDirty,
      ...
      {suggestions.map((suggestion) => {
        ...
        return (
          <Button
            ...
            key={suggestion.type}
            onClick={() => onCreateSuggestedAction(createPayload({
              record,
              suggestion,
            }))}
            size="sm"
            ...
            variant="outline"
          >
            {suggestion.hasOpenAction ? 'Action exists' : wasCreated ? 'Action created' : getSuggestionLabel(suggestion)}
          </Button>
        )
      })}
    </div>
