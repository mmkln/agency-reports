...
export const WORKSPACE_ROLE_META = Object.freeze({
  ...
  [WORKSPACE_ROLES.PRACTICE_MANAGER]: { label: 'Practice Manager', tone: 'blue' },
  [WORKSPACE_ROLES.DOCTOR_REVIEWER]: { label: 'Doctor Reviewer', tone: 'purple' },
...
const WORKSPACE_ROLE_DEFAULT_CAPABILITIES = Object.freeze({
  ...
  [WORKSPACE_ROLES.PRACTICE_MANAGER]: ALL_WORKSPACE_CAPABILITIES,
  [WORKSPACE_ROLES.DOCTOR_REVIEWER]: [
    WORKSPACE_CAPABILITIES.VIEW_PORTAL,
    WORKSPACE_CAPABILITIES.REVIEW_APPROVALS,
    WORKSPACE_CAPABILITIES.MEDICAL_APPROVE,
    WORKSPACE_CAPABILITIES.REVIEW_COMPLIANCE,
    WORKSPACE_CAPABILITIES.VIEW_FILES,
    WORKSPACE_CAPABILITIES.VIEW_REPORTS,
    WORKSPACE_CAPABILITIES.VIEW_DASHBOARDS,
