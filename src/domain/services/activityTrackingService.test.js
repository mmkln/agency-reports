...
describe('activityTrackingService', () => {
  ...
  it('keeps internal review events out of the client-visible activity policy', () => {
    ...
    expect(isActivityEventVisibleToClient(ACTIVITY_EVENT_TYPES.CLIENT_INVITATION_CREATED)).toBe(false)
    expect(isActivityEventVisibleToClient(ACTIVITY_EVENT_TYPES.CLIENT_INVITATION_CANCELLED)).toBe(false)
    expect(isActivityEventVisibleToClient(ACTIVITY_EVENT_TYPES.CLIENT_INVITATION_ACCEPTED)).toBe(false)
