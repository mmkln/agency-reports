  ...
  return (
    <div className="relative mb-8 h-64 w-64">
      <svg className="h-full w-full -rotate-90 transform" viewBox="0 0 42 42">
        <circle cx="21" cy="21" fill="transparent" r="15.91549430918954" stroke="#f1f5f9" strokeWidth="6" />
      ...
      <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center">
        ...
        <span className="text-xs font-semibold tracking-wider text-slate-500 uppercase">{centerLabel}</span>
      </div>
    </div>
  )
}
